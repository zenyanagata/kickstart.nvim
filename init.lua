...
-- cursor settings
-- Block: normal/visual mode, Vertical bar: insert mode, Horizontal bar: replace mode
...
require('lazy').setup({
    ...
    config = function()
      require('nvim-tree').setup {
        ...
        filters = {
          ...
          git_ignored = false, -- Do not ignore files based on .gitignore
        },
        git = {
        ...
        on_attach = function(bufnr)
          ...
          vim.keymap.set('n', 'H', api.tree.collapse_all, opts 'Colapse All')
        end,
      }
    end,
  },
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        -- TODO: this doesn't change the default cmd, needs further investigation
        -- Instead, fixing the original ~/.local/share/nvim/lazy/nvim-lspconfig/lsp/clangd.lua
        clangd = {
          cmd = { 'cclangd', 'tools-tup-builder-1.0.0-container' },
          root_dir = function()
            return '/builder_work'
          end,
        },
